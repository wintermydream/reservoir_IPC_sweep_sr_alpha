...
if __name__ == '__main__':
    ...
    #spectrum_radius_list = [0.6, 0.8, 1.0, 1.2, 1.4, 1.6]
    ...
    for spectrum_radius in spectrum_radius_list:
        ...
        for alpha in alpha_list:
            for omega in omega_list:
                output_file = f"res_N{num_nodes}_sr{spectrum_radius:.3f}_om{omega:.3f}_al{alpha:.3f}.npz"
                ...
                print(f"[{run_count}] Saved: {output_file} (spectrum_radius={spectrum_radius:.3f}, alpha={alpha:.3f}, omega={omega:.3f}) | Time elapsed: {elapsed:.2f} s") 